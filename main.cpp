/*
   ...
   --------------------------------------------------------------
   Mandatory algorithms used:
     - DDA Line Algorithm
     - Bresenham Line Algorithm
     - Midpoint Circle Algorithm

   Mandatory transformations used (OpenGL matrix transforms):
     - Translation: train movement, passenger movement, clouds
     - Rotation: wheel rotation
     - Scaling: object sizing (buildings, trees, etc.)
   ...
   Build (Code::Blocks + GLUT):
     - Link with: opengl32, glu32, freeglut (or glut32 depending on your setup)
*/
